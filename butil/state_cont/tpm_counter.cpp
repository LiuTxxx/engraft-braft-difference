#include "butil/state_cont/tpm_counter.h"
#include "butil/third_party/tss2/util/tss2_endian.h"
#include "gflags/gflags.h"
#include "butil/strings/string_util.h" //- int_to_hex
...
int TPMCounter::init() {
    ...
    LOG(INFO) << "Func: " << __FUNCTION__ << " handle = " << session_handle;
